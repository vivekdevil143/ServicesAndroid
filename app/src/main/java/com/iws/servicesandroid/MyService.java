...
public class MyService extends Service {
    ...
    public void onDestroy() {
        super.onDestroy();
        Log.i(getString(R.string.service_demo_tag), " Service destory");
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        Log.i(getString(R.string.service_demo_tag), " startcommand thread id:" + Thread.currentThread().getId());

        //stopSelf(); // it will stop the service
